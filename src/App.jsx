    ...
    <div className="neo-app">
      <div className="neo-top">
        <div className="neo-logo">
          ...
          <div>
            <div className="neo-title">David Baquero</div>
          </div>
        </div>
      ...
      <div className="neo-container">
        <div className="neo-left">
          <div className="neo-card">
            ...
            {showForm ? (
              ...
              <p className="muted">Selecciona "Crear" para crear un nuevo elemento</p>
            )}
          </div>

          <div className="neo-card neo-board-card">
            <h2>apartado de elementos</h2>

            {loading && <p className="muted">esperando elementos...</p>}
            {error && <p className="error">{error}</p>}

            {!loading && !error && (
              <div className="neo-board-grid">
                <div>
                  <h4 className="neo-column-title">pendiente ({todo.length})</h4>
                  <TaskList tasks={todo} onToggle={handleToggleTask} onDelete={handleDeleteTask} onEdit={handleEditTask} />
                </div>
                <div>
                  <h4 className="neo-column-title">Finalizado ({done.length})</h4>
        ...
        <aside className="neo-right">
          <div className="neo-card neo-stats">
            ...
            <p>Finalizadas: <strong>{done.length}</strong></p>
          </div>

          <div className="neo-card neo-help">
            <h3>Explicación</h3>
            <ul>
              <li>Accede al registro para ajustarlo.</li>
              <li>Al completarlo se transfiere a Completado.</li>
              <li>Estilo minimalista y contemporáneo.</li>
            </ul>
          </div>
        </aside>
      </div>
